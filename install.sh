...
CREATE DATABASE IF NOT EXISTS `ox_core_717196` DEFAULT CHARACTER
...
ALTER TABLE `characters`
 ADD FULLTEXT INDEX `characters_fullName_index` (`fullName`);

ALTER TABLE `characters`
 ADD INDEX `characters_userId_key` (`userId`);
...
ALTER TABLE `accounts`
 ADD FULLTEXT INDEX `accounts_label_index` (`label`);
...
ALTER TABLE `accounts_transactions`
 ADD FULLTEXT INDEX `accounts_transactions_message_index` (`message`);
...
ALTER TABLE `accounts_invoices`
 ADD FULLTEXT INDEX `idx_message_fulltext` (`message`);
